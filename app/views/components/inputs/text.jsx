...
class Text extends Component {
    ...
    render() {
        ...
        if (this.props.multLines)
            input = <textarea data-container={this.props.container} className={`${this.props.className} form-control`} type={this.props.type || 'text'} name={this.props.name} id={this.props.id} defaultValue={this.props.value || ""} required={this.props.required}></textarea>
        else
